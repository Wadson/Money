...
namespace Money
{
    public partial class FrmRel_AgrupadoSubCategoria : Form
    {
        public FrmRel_AgrupadoSubCategoria()
        {
            InitializeComponent();
        }

        private void FrmRel_AgrupadoSubCategoria_Load(object sender, EventArgs e)
        {
